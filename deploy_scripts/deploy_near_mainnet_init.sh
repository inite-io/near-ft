...
near call $CONTRACT_NAME new '{"owner_id": "'$CONTRACT_NAME'", "total_supply": "1000000000000000000000000000000000", "metadata": { "spec": "ft-1.0.0", "name": "INIT Token", "symbol": "INIT", "decimals": 24 }}' --accountId $CONTRACT_NAME
