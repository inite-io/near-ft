...
near call $CONTRACT_NAME new '{"owner_id": "'$CONTRACT_NAME'", "total_supply": "0", "metadata": { "spec": "ft-1.0.0", "name": "IDEA Token", "symbol": "IDEA", "decimals": 24 }}' --accountId $CONTRACT_NAME
